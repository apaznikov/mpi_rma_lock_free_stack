...
/*
 * Программа для измерения продолжительности нескольких операций POP
 * для децентрализованного стека Трейбера.
 */
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        runStackOnlyPopBenchmarkTask(rmaTreiberStack, comm, fileBenchmarkSink);
